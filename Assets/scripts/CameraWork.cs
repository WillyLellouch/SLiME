...
public class CameraWork : MonoBehaviour {
    ...
    //For example a follow camera shoud always be implemented in LateUpdate because objects that might have moved inside Update.
	void LateUpdate ()
    {
    ...
    //Directly position the camerato a specified Target and center.
    void Cut()
    {
    ...
    //param name = "centerPos" > Center position.
